...
const saasMenu = r => require.ensure([], () => r(require('@/page/saas/account/menu.vue')), 'saasMenu'); // 导航菜单管理
...
// 客户端
const client = r => require.ensure([], () => r(require('@/page/saas/client/client.vue')), 'client'); // 客户端
