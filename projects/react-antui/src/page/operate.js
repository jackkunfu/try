...
export default class Base extends Utils {
    constructor(){
        ...
        // this.curEditing = {}; //  当前正在编辑的对象
        // this.editItem = {}; //  新增\编辑区域对象
        // this.tableData = [];
        // this.totalPage = null;
        // this.currentPage = 1;
        // this.isInput = false; //  是不是编辑或者新增的状态，用于控制展示列表还是新增编辑区域
        // this.curOperate = '新增'; //  当前的操作状态-新增 编辑  或其他
        // this.searchMsg = {}; // 搜索区域对象
        // // 1-搜索 2-添加 3-保存  4-修改 5-删除 6-冻结 7-解绑 8-上下架  9-配置店长(门店配置)  10-导入  11-导出
        // this.permissionOpt = ['search', 'add', 'save', 'edit', 'del', 'freeze', 'unbund', 'shelf', 'shop', 'import', 'export'];
        // this.tabOp = [];
    }
    ...
    // pageChange(v) { // 翻页改变
    //     if(!v || v == 1) return   // 可能接口返回页码数据有点异常， 这里加个判断可以避免多次触发请求
    //     this.tableList(v);
    // }
