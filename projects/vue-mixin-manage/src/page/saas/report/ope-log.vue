                ...
                .search-ctn
                    el-form(:inline="true" :model="searchMsg" class="demo-form-inline")
                        ...
                        el-form-item(label="会员姓名")
                            el-input(type="text" v-model="searchMsg.userRealname")

                        el-form-item(label="会员手机号")
                            el-input(type="text" v-model="searchMsg.userMobile")

                        el-form-item(label="账号名称")
                            el-input(type="text" v-model="searchMsg.optRealname")

                        el-form-item(label="账号手机")
                            el-input(type="text" v-model="searchMsg.optMobile")

                        el-form-item(label="账号所属门店")
                            el-input(type="text" v-model="searchMsg.storeName")
