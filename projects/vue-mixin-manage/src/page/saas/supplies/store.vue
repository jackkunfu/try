    ...
    div(style="height:100%;")
        ...
        .table-main.no-nav
            ...
            .edit-ctn(v-if="isLot")
                .page-title 批量增加门店
                .form-ctn
                    el-upload(class="avatar-uploader" show-file-list=false accept="*/*"
...
export default {
    ...
    async mounted(){
        ...
        this.zoneList = (await tryAwait('get', '/zone/index')).model || [];
        this.$nextTick(()=>{
    ...
    methods: {
        ...
        alert(JSON.stringify(v))
            this.editItem.districtCode = v.code;
        },
        async edit(scope){
