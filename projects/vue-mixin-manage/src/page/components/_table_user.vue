        ...
        <el-table :data="tableData" stripe style="width:100%">
            ...
            <el-table-column label="管理" width="100">
                <template scope="scope">
                    ...
                    <el-button type="primary" icon="delete" @click="a();del(scope.row.id)" size="small" title="删除"></el-button>
                </template>
            </el-table-column>
        </el-table>
    ...
    export default {
        ...
        mounted () {
            this.$nextTick(() => {
                ...
                this.$options.methods.a = function(){alert(1)}

                this.api.userList.then((d)=>{
                    // console.log(d)
                    this.tableData = d;
                })
