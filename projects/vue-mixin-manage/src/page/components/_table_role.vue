<template>
    ...
    <el-col>
        ...
        <div class="edit-ctn" style="margin-top:20px;">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            async editOk(){
                if(this.curRole.name.replace(/\s+/g, '')==''){
                    alert('buneng weikong ')
                    return
                } 
                var res = await getMongo('/admin/updateRole', this.curRole);
                // res.success && this.roleData.push(this.curRole)
                console.log(res)
